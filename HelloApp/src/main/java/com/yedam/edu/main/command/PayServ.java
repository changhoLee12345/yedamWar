...
//		connection.setRequestProperty("Authorization", "KakaoAK 2bb22c2460e07f8998d89b80b2771508"); // 어드민 키
...
//		}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			// 받는 부분
			response.getWriter().print(change.readLine()); // 문자열로 형변환을 알아서 해주고 찍어낸다 그리고 본인은 비워진다.
